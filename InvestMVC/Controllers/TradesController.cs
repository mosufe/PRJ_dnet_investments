...
namespace InvestMVC.Controllers
{
    public class TradesController : Controller
    {
        ...
        public TradesController(InvestMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id")] Trade trade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id")] Trade trade)
        {
            if (id != trade.Id)
            {
                return NotFound();
